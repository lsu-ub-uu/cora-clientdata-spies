...
public class ClientDataListSpy implements ClientDataList {
	public MethodCallRecorder MCR = new MethodCallRecorder();
	public MethodReturnValues MRV = new MethodReturnValues();

	public ClientDataListSpy() {
		MCR.useMRV(MRV);
		...
		MRV.setDefaultReturnValuesSupplier("getDataList", ArrayList<ClientData>::new);
	}
	...
	public List<ClientData> getDataList() {
		return (List<ClientData>) MCR.addCallAndReturnFromMRV();
	}
