...
public class ClientDataChildFilterSpyTest {

	private static final String ADD_CALL = "addCall";
	private static final String ADD_CALL_AND_RETURN_FROM_MRV = "addCallAndReturnFromMRV";
	ClientDataChildFilterSpy dataChildFilterSpy;
	...
	public void beforeMethod() {
		...
		dataChildFilterSpy = new ClientDataChildFilterSpy();
	}
	...
	public void testDefaultChildMatches() throws Exception {
		ClientDataChildSpy child = new ClientDataChildSpy();
