...
public class ClientDataChildSpyTest {
	private static final String ADD_CALL = "addCall";
	private static final String ADD_CALL_AND_RETURN_FROM_MRV = "addCallAndReturnFromMRV";
	ClientDataChildSpy dataChild;
	...
	public void beforeMethod() {
		...
		dataChild = new ClientDataChildSpy();
	}
	...
	public void testDefaultGetAttribute() throws Exception {
		assertTrue(dataChild.getAttribute("nameInData") instanceof ClientDataAttribute);
	}
	...
	public void testDefaultGetAttributes() throws Exception {
		assertTrue(dataChild.getAttributes() instanceof Collection<ClientDataAttribute>);
	}
