...
public class ClientDataListSpyTest {
	private static final String ADD_CALL = "addCall";
	private static final String ADD_CALL_AND_RETURN_FROM_MRV = "addCallAndReturnFromMRV";
	ClientDataListSpy dataList;
	...
	public void beforeMethod() {
		...
		dataList = new ClientDataListSpy();
	}
	...
	public void testGetDataList() throws Exception {
		...
		MCRSpy.MRV.setDefaultReturnValuesSupplier(ADD_CALL_AND_RETURN_FROM_MRV,
				ArrayList<ClientData>::new);

		List<ClientData> returnedValue = dataList.getDataList();
	...
	public void testAddData() throws Exception {
		ClientData data = new ClientDataRecordSpy();
		dataList.MCR = MCRSpy;
